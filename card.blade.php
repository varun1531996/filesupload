                            ...
                            <div class="card_box">
                                ...
                                <div class="img_sec">
                                    @if(!isset($card->video_url))
                                        <div class="owl-image owl-carousel owl-theme"> 
                                            <?php $fullUrl = $card->custom_thumbnail;
                                                    ...
                                                    @foreach($imageArray as $image)
                                                        <div class="col-md-12">
                                                            <a href="javascript:void(0);" class="" style="cursor: default;">
                                                                <img src="{{ url('uploads/images/' . $image) }}" alt="responsive-image"
                                ...
                                <div class="content_txt">
                                    ...
                                    <h3>{{ $card->title }}  
                                        ...
                                        @if($card->brochure != 'javascript:void(0)')
                                            <a href="{{ $card->brochure }}" target="_blank">
                                                <button type="button" class="btn btn-primary btn-md float-right">Brochure</button>
                                            </a>    
                                        @endif
