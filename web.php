...
Route::group(['middleware' => 'auth', 'prefix' => config('constants.admin_page'), 'namespace' => 'AdminController'], function () {
    ...
    Route::get('/partners/edit/{id}', 'PartnersController@edit')->name('admin-partners-edit');
    Route::post('/partners/update/{id}', 'PartnersController@updatePartners')->name('admin-partners-update');
    Route::delete('/partners/destroy/{id}', 'PartnersController@destroy')->name('admin-partners-destroy');
